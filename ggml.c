...
static void quantize_row_q4_0(const float *  x, void *  y, int k) {
...
static void quantize_row_q4_1(const float *  x, void *  y, int k) {
...
static void quantize_row_q5_0(const float *  x, void *  y, int k) {
...
static void quantize_row_q5_1(const float *  x, void *  y, int k) {
...
static void ggml_vec_dot_q4_0_q8_0(const int n, float *  s, const void *  vx, const void *  vy);
static void ggml_vec_dot_q4_1_q8_1(const int n, float *  s, const void *  vx, const void *  vy);
static void ggml_vec_dot_q5_0_q8_0(const int n, float *  s, const void *  vx, const void *  vy);
static void ggml_vec_dot_q5_1_q8_1(const int n, float *  s, const void *  vx, const void *  vy);
static void ggml_vec_dot_q8_0_q8_0(const int n, float *  s, const void *  vx, const void *  vy);
...
static void ggml_vec_dot_q4_1_q8_1(const int n, float *  s, const void *  vx, const void *  vy) {
    ...
    const block_q4_1 *  x = vx;
    const block_q8_1 *  y = vy;
